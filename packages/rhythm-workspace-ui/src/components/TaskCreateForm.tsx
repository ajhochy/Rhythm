// Ported verbatim from apps/web/src/components/TaskCreateForm.tsx.
...
export function TaskCreateForm({
  ...
  return (
    <form className="task-editor-form" onSubmit={onSubmit} noValidate={noValidate}>
      <fieldset disabled={disabled} aria-disabled={disabled || undefined} aria-describedby={describedBy} data-testid={testIds.mutations}>
        ...
        <div className="task-editor-pair">
          <label className="task-editor-field">
            ...
            <input name="scheduledDate" type="date" defaultValue={defaultScheduledDate} data-testid={testIds.scheduledDate} />
          </label>
          <label className="task-editor-field">
            <span>Due date</span>
            <input name="dueDate" type="date" data-testid={testIds.dueDate} />
          </label>
        </div>

        <section className="task-editor-section" aria-labelledby={`${idPrefix}-people-title`}>
          ...
          <label className="task-editor-field">
            ...
            <select name="collaboratorId" defaultValue="" data-testid={testIds.collaborator}>
        ...
        <footer className="task-editor-footer">
          <button className="secondary-button" type="button" onClick={onCancel} data-testid={testIds.cancel}>Cancel</button>
          <button className="primary-button" type="submit" data-testid={testIds.submit}>Create task</button>
        </footer>
      </fieldset>
    </form>
  );
