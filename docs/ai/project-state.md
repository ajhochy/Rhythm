...
### 2026-08-21 — D4.4 #1442 parent-review repair

- Restored this D2 project-state history; #1442 now permits only authenticated admin/system users and exposes availability only for flagged SQLite runtimes.
