...
- #1132: SDK deterministic build/typecheck, API lint/typecheck/build/full
  suite, Docker build, containment suites, and live event smoke pass.
- #1135: API build, full workflow gates, focused 110-test suite, contract
  validation, fork build, and live smoke 2/2 pass.
