...
- Pinned Hermes Desktop source `ba0de5c2068ba3fe9ad986952f644056610b64fb`.
...
- Final artifact build: `npm run build:rhythm-embedded` — 424 integrity entries; manifest `sourceCommit=ba0de5c2068ba3fe9ad986952f644056610b64fb`, `dirty=false`, `electronMajor=40`.
