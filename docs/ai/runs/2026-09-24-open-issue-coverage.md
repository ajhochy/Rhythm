...
| [#1535](https://github.com/ajhochy/Rhythm/issues/1535) | [COL-10] Make release CI the Colony artifact producer | Original Colony implementation plan exists; embedded artifact, bridge/tab/packaging or release slice remains. |
| [#1534](https://github.com/ajhochy/Rhythm/issues/1534) | [COL-09] Stage the sealed Colony artifact in the Mac package | Original Colony implementation plan exists; embedded artifact, bridge/tab/packaging or release slice remains. |
| [#1533](https://github.com/ajhochy/Rhythm/issues/1533) | [COL-08] Complete resource behavior, accessibility and failure recovery | Original Colony implementation plan exists; embedded artifact, bridge/tab/packaging or release slice remains. |
| [#1532](https://github.com/ajhochy/Rhythm/issues/1532) | [COL-07] Add local opt-in, persistent preferences and reversible import | Original Colony implementation plan exists; embedded artifact, bridge/tab/packaging or release slice remains. |
| [#1531](https://github.com/ajhochy/Rhythm/issues/1531) | [COL-06] Connect exact task actions and Rhythm-native menus | Original Colony implementation plan exists; embedded artifact, bridge/tab/packaging or release slice remains. |
