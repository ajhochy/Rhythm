...
| [#1424](https://github.com/ajhochy/Rhythm/issues/1424) | Mega plan 1042–1108: complete the live/manual verification matrix | Partial matrix with provider-free rows proved: files/VCS/shell/init pass; command reload refreshes without restart; three busy prompts arrive exactly once in order; multi-select and permission-rejection round trips pass. Real-provider and installed/notarized-app rows remain. See [2026-09-25 run](2026-09-25-issue-1424-provider-free-live-matrix.md). |
