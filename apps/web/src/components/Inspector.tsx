...
export function Inspector({ collapsed, onToggle }: { collapsed: boolean; onToggle(): void }) {
  const { inspectorTab, setInspectorTab, todos, selected } = useFixtures();
  ...
  const panel = inspectorTab === 'context' ? <ContextPanel /> : inspectorTab === 'changes' ? <ChangesPanel trace={trace} setTrace={setTrace} /> : inspectorTab === 'terminal' ? <TerminalPanel pty={pty} updatePty={updatePty} trace={trace} setTrace={setTrace} /> : inspectorTab === 'files' ? <FilesPanel trace={trace} setTrace={setTrace} /> : <ArtifactsPanel trace={trace} setTrace={setTrace} />;
