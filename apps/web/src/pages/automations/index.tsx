...
export function AutomationsPage({ route }: { route: string }) {
  ...
  return <section className="page-shell pg-automations" data-testid="page-automations" aria-labelledby="automations-title" aria-busy={surfaceState === 'loading'} {...(selectedRuleId ? { 'data-selected-stable-id': selectedRuleId } : {})}>
    ...
    <section className="automations-overview" aria-label="Automation summary"><dl><div><dt>Rules</dt><dd data-testid="automations-rule-count">{showsRules ? rules.length : 0}</dd></div><div><dt>Enabled</dt><dd data-testid="automations-enabled-count">{showsRules ? enabledCount : 0}</dd></div><div><dt>Connected providers</dt><dd data-testid="automations-provider-count">3</dd></div><div><dt>Latest account sync</dt><dd>Aug 12 · 15:45</dd></div></dl></section>
