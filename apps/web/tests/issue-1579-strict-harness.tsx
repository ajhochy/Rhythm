...
createRoot(document.getElementById('root')!).render(<StrictMode><AuthUserProvider user={{ id: 4189, name: 'E22', email: 'e22@example.invalid', role: 'user' }}><GatewayProvider gateway={gateway}><FixtureProvider><Probe /></FixtureProvider></GatewayProvider></AuthUserProvider></StrictMode>);
