...
function Probe() {
  ...
  return <><SessionRail collapsed={false} onToggle={() => {}} selectedProject={null} onSelectProject={() => {}} /><pre data-testid="state">{JSON.stringify({ sessions: state.sessions, selectedId: state.selectedId, selected: state.selected })}</pre>
