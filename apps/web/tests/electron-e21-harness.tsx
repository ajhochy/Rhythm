...
function Probe() {
  ...
  return <><SessionRail collapsed={false} onToggle={() => {}} /><pre data-testid="state">{JSON.stringify({ sessions: state.sessions, selectedId: state.selectedId, selected: state.selected, toast: state.toast })}</pre>
