            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  _LifecycleBadge(state: entry.lifecycleState),
                  if (entry.unverifiable) ...[
                    const SizedBox(width: RhythmSpacing.xs),
                    const _LifecycleBadge(state: 'unverifiable'),
                  ],
                  const Spacer(),
                  IconButton(
                    icon: Icon(
              ...
              if (_expanded) ...[
                ...
                Text(
                  ...
                  '${entry.verificationCount} verification'
                  '${entry.verificationCount == 1 ? '' : 's'}',
                  style: TextStyle(
                    color: context.rhythm.textMuted,
                    fontSize: 11,
                  ),
                ),
                if (entry.staleAfter != null)
                  Text(
                    'Stale after: ${entry.staleAfter}',
                    style: TextStyle(
                      color: context.rhythm.textMuted,
                      fontSize: 11,
                    ),
