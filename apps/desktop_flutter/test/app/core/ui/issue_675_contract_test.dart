...
void main() {
  testWidgets('issue-675-c1: inspector opens in edit mode by default '
      '(Save/Cancel visible, no Edit details click required)', (tester) async {
  ...
  testWidgets('issue-675-c2: calendar shadow-event tasks remain read-only '
      'despite the edit-mode default', (tester) async {
    await openInspector(tester, makeTask(sourceType: 'calendar_shadow_event'));

    expect(
      find.text('TASK INSPECTOR · READ ONLY'),
      findsOneWidget,
