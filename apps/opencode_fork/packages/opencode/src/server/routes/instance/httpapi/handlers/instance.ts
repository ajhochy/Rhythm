...
export const instanceHandlers = HttpApiBuilder.group(InstanceHttpApi, "instance", (handlers) =>
  Effect.gen(function* () {
    ...
    const reloadConfig = Effect.fn("InstanceHttpApi.configReload")(function* () {
      ...
      // invalidate the Agent and Command services' per-directory InstanceState,
      // which hold stale config.get() results. Without these invalidations,
      // agent and command lists still return their pre-reload snapshots after
      // the global cache is cleared.
