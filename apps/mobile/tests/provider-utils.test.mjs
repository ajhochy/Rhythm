...
const { defaultChatPreferences, getConfiguredProviderIds } = await import(`data:text/javascript,${encodeURIComponent(output)}`);
...
assert.equal(defaultChatPreferences.workingSoundEnabled, false, 'processing audio must be opt-in');
