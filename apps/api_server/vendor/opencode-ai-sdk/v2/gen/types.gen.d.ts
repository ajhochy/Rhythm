...
export type AssistantMessage = {
    ...
    error?: ProviderAuthError | UnknownError | MessageOutputLengthError | MessageAbortedError | StructuredOutputError | ContextOverflowError | ApiError | CompactionLoopError;
    parentID: string;
    modelID: string;
    providerID: string;
    mode: string;
