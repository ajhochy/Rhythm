...
export type AssistantMessage = {
    ...
    error?: ApiError | CompactionLoopError | ContextOverflowError | MessageAbortedError | MessageOutputLengthError | ProviderAuthError | StructuredOutputError | UnknownError;
    parentID: string;
    modelID: string;
    providerID: string;
    mode: string;
...
export type EventSessionNextToolProgress = {
    ...
    properties: {
        ...
        content: Array<ToolFileContent | ToolTextContent>;
    };
};
...
export type Part = AgentPart | CompactionPart | FilePart | PatchPart | ReasoningPart | RetryPart | SnapshotPart | StepFinishPart | StepStartPart | SubtaskPart | TextPart | ToolPart;
...
export type SessionMessage = SessionMessageAgentSwitched | SessionMessageAssistant | SessionMessageCompaction | SessionMessageModelSwitched | SessionMessageShell | SessionMessageSynthetic | SessionMessageUser;
...
export type SessionMessageAssistant = {
    ...
    content: Array<SessionMessageAssistantReasoning | SessionMessageAssistantText | SessionMessageAssistantTool>;
    snapshot?: {
        start?: string;
        end?: string;
    };
...
export type SessionMessageAssistantTool = {
    ...
    state: SessionMessageToolStateCompleted | SessionMessageToolStateError | SessionMessageToolStatePending | SessionMessageToolStateRunning;
    time: {
        created: number;
        ran?: number;
        completed?: number;
...
export type ExperimentalWorkspaceWarpErrors = {
     ...
     */
    400: VcsApplyError | WorkspaceWarpError;
};
