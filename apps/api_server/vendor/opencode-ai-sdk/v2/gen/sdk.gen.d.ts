...
export declare class Skills extends HeyApiClient {
    ...
    reload<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
        workspace?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<AppSkillsReloadResponses, unknown, ThrowOnError, "fields">;
}
export declare class Config extends HeyApiClient {
    ...
    reload<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
        workspace?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<AppConfigReloadResponses, unknown, ThrowOnError, "fields">;
}
...
export declare class Mcp extends HeyApiClient {
     ...
     */
    tools<ThrowOnError extends boolean = false>(parameters?: {
        directory?: string;
        workspace?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<McpToolsResponses, unknown, ThrowOnError, "fields">;
    /**
...
export declare class Session2 extends HeyApiClient {
     ...
     */
    mcpAppResource<ThrowOnError extends boolean = false>(parameters: {
        sessionID: string;
        callID: string;
        directory?: string;
        workspace?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<SessionMcpAppResourceResponses, SessionMcpAppResourceErrors, ThrowOnError, "fields">;
    /**
     * Issue a session-bound MCP App execution proof
     */
    mcpAppExecutionProof<ThrowOnError extends boolean = false>(parameters: {
        sessionID: string;
        callID: string;
        directory?: string;
        workspace?: string;
    ...
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<SessionMcpAppExecutionProofResponses, SessionMcpAppExecutionProofErrors, ThrowOnError, "fields">;
    /**
     * Execute an authorized same-server MCP App tool call
     */
    mcpAppExecution<ThrowOnError extends boolean = false>(parameters: {
        sessionID: string;
        callID: string;
        directory?: string;
        workspace?: string;
        ...
        requestID?: string;
    }, options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<SessionMcpAppExecutionResponses, SessionMcpAppExecutionErrors, ThrowOnError, "fields">;
}
...
export declare class Model extends HeyApiClient {
     ...
     */
    list<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<V2ModelListResponses, unknown, ThrowOnError, "fields">;
}
export declare class Provider2 extends HeyApiClient {
     ...
     */
    list<ThrowOnError extends boolean = false>(options?: Options<never, ThrowOnError>): import("./client/types.gen.js").RequestResult<V2ProviderListResponses, unknown, ThrowOnError, "fields">;
    /**
     * Get v2 provider
     *
