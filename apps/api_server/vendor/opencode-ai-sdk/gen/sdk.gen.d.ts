...
declare class Session extends _HeyApiClient {
     ...
     */
    mcpAppResource<ThrowOnError extends boolean = false>(options: Options<SessionMcpAppResourceData, ThrowOnError>): import("./client/types.gen.js").RequestResult<SessionMcpAppResourceResponses, SessionMcpAppResourceErrors, ThrowOnError, "fields">;
    /**
