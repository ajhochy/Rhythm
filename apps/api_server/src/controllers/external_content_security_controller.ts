...
export const EXTERNAL_CONTENT_TOOLS = new Map<string, string>([
  ...
  ['research.project.list', 'rhythm_list_research_projects'],
  ['research.project.get', 'rhythm_get_research_project'],
  ['research.project.run', 'rhythm_get_research_project_run'],
...
export const SECURITY_ACTION_TOOLS = new Map<string, string>([
  ...
  ['research.complete-pass', 'rhythm_complete_research_pass'],
  ['research.project.create', 'rhythm_create_research_project'],
  ['research.project.update', 'rhythm_update_research_project'],
  ['research.project.archive', 'rhythm_archive_research_project'],
  ['research.project.run.start', 'rhythm_start_research_project_run'],
