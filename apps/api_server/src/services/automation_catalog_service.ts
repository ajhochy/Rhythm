...
const TRIGGERS: AutomationTriggerCatalogItem[] = [
  ...
  },
  {
    ...
    label: 'Plan upcoming',
    description: 'Match Planning Center plans approaching their service date.',
  ...
  },
  {
    ...
    description: 'Match Planning Center plans when they are published.',
    signalTypes: ['plan_published'],
    configSchema: { fields: ['serviceType'] },
  },
  {
    key: 'planning_center.service_item_updated',
    source: 'planning_center',
    label: 'Service item updated',
    description: 'Match Planning Center service items in upcoming plans.',
    signalTypes: ['service_item_updated'],
    configSchema: { fields: ['serviceType', 'leadDays'] },
  },
  {
